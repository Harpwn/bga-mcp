 ...
 */
export const WORKSPACE_PATH = process.env.BGA_WORKSPACE_PATH;
// ---------------------------------------------------------------------------
// BGA Wiki API
// ---------------------------------------------------------------------------
 ...
 * the AI can look up.
 */
export const BGA_DOC_PAGES = [
    // ── Game logic (Server side) ──────────────────────────────────────────────
    {
        alias: "main_game_logic",
        wikiPage: "Main_game_logic:_Game.php",
        description: "Game.php — central server class covering: setupNewGame, getAllDatas, getGameProgression, " +
    ...
    },
    {
        ...
        description: "(Deprecated — prefer State classes) states.inc.php — legacy PHP-array state machine using GameStateBuilder. " +
    ...
    },
    {
        ...
        description: "modules/php/States/ — modern recommended approach: one PHP class per state extending GameState. " +
    ...
    },
    {
        ...
        description: "(Deprecated — use autowired act* methods instead) action.php — legacy AJAX-to-PHP bridge. " +
    ...
    },
    {
        alias: "notifications",
        wikiPage: "Main_game_logic:_Game.php",
        description: "BGA notifications system (documented in Game.php wiki): bga->notify->all() and bga->notify->player() " +
    ...
    },
    {
        ...
        description: "dbmodel.sql — MySQL InnoDB schema file executed at table creation. " +
    ...
    },
    {
        ...
        description: "material.inc.php — static game data file for card types, token definitions, PHP constants, and tooltips. " +
    ...
    },
    {
        ...
        description: "stats.json — defines int/float/bool table and player statistics shown at game end. " +
    ...
    // ── Game interface (Client side) ─────────────────────────────────────────
    {
        ...
        description: "Game.js (modules/js/Game.js) — main client-side JS file for the game interface. " +
    ...
    {
        alias: "game_layout",
        wikiPage: "Game_layout:_view_and_template:_yourgamename.view.php_and_yourgamename_yourgamename.tpl",
        description: "DEPRECATED — prefer generating templates from JS (see Reversi tutorial). " +
    ...
    },
    {
        ...
        description: "yourgamename.css — single CSS file for the entire game interface (no additional CSS imports allowed; compressed on production). " +
    ...
    },
    {
        ...
        description: "img/ directory — stores all game images. Root-level images are preloaded by default on page load (keep small); " +
    ...
    },
    {
        ...
        description: "Mobile and tablet support guide. Primary setting: game_interface_width in gameinfos.inc.php — " +
    ...
    // ── Other file references ─────────────────────────────────────────────────
    {
        ...
        description: "Quick reference for every file in a BGA game project, with reload requirements. " +
    ...
    },
    {
        ...
        description: "gameinfos.inc.php — PHP file with game meta-information. After changes click 'Reload game informations' in Control Panel. " +
    ...
    },
    {
        ...
        description: "gameoptions.json — table-wide game variants chosen by table creator (IDs 100+). " +
    ...
    },
    {
        ...
        description: "BGA i18n workflow: games developed in English; translation happens on the CLIENT. Never send localized strings from server. " +
    ...
    },
    {
        ...
        description: "Game replay is handled entirely by the framework — no special replay code needed in your game. " +
    ...
    // ── JS Components ─────────────────────────────────────────────────────────
    {
        alias: "counter",
        wikiPage: "Counter",
        description: "ebg/counter — built-in JS component for animated numeric counters (preloaded, no import needed). " +
    ...
    },
    {
        alias: "scrollmap",
        wikiPage: "Scrollmap",
        description: "ebg/scrollmap — JS component for an infinite/boundless scrollable game area (examples: Carcassonne, Saboteur, Takenoko). " +
    ...
    },
    {
        alias: "stock",
        wikiPage: "Stock",
        description: "ebg/stock — JS component to display and manage a set of same-size game elements at a position. " +
    ...
    },
    {
        alias: "zone",
        wikiPage: "Zone",
        description: "ebg/zone — JS component to organise tokens/pieces in a fixed-size area. " +
    ...
    },
    {
        alias: "draggable",
        wikiPage: "Draggable",
        description: "ebg/draggable — legacy JS component for drag-and-drop interactions. " +
    ...
    },
    {
        ...
        description: "bga-animations — modern Promise-based JS animation library. " +
    ...
    },
    {
        alias: "bga_cards",
        wikiPage: "BgaCards",
        description: "bga-cards — modern JS card management library; recommended replacement for Stock in card games. " +
    ...
    },
    {
        alias: "bga_dice",
        wikiPage: "BgaDice",
        description: "bga-dice — JS component for dice display and roll animations. " +
    ...
    // ── PHP Components ────────────────────────────────────────────────────────
    {
        alias: "deck",
        wikiPage: "Deck",
        description: "PHP Deck component — server-side card/token manager; eliminates manual SQL for decks and hands. " +
    ...
    },
    {
        ...
        description: "PHP PlayerCounter and TableCounter — server-side numeric counters that auto-sync to JS ebg.counter. " +
    ...
    // ── Studio User Guide ─────────────────────────────────────────────────────
    {
        ...
        description: "First steps with BGA Studio — getting your local environment connected and making your first change. " +
    ...
    },
    {
        ...
        description: "Complete walkthrough: creating a game from scratch in BGA Studio, step by step. " +
    ...
    },
    {
        ...
        description: "Tutorial: Reversi — the official BGA beginner tutorial, maintained by the BGA team. " +
    ...
    },
    {
        ...
        description: "BGA Studio coding and UX/UI guidelines that games must meet for alpha/beta/release approval. " +
    ...
    },
    {
        ...
        description: "One-liners on the most common missed features, gotchas, and time-saving tricks in BGA Studio. " +
    ...
    },
    {
        ...
        description: "Practical debugging tools and techniques for BGA games in Studio. " +
    ...
    },
    {
        ...
        description: "Solutions to common 'I am really stuck' situations in BGA Studio. " +
    ...
    },
    {
        ...
        description: "BGA game lifecycle: the stages a game passes through from creation to full public release. " +
    ...
    },
    {
        alias: "faq",
        wikiPage: "Studio_FAQ",
        description: "BGA Studio frequently asked questions — quick answers to common developer queries. " +
    ...
    },
    {
        ...
        description: "Migration guide for upgrading an existing BGA game from the legacy framework to the modern architecture. " +
    ...
    },
    {
        ...
        description: "How to use TypeScript and SCSS (Dart Sass) in BGA game development as an optional local build step. " +
    ...
    },
    {
        ...
        description: "BGA Studio Cookbook — copy-paste recipes and patterns for common implementation scenarios. " +
