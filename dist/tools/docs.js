...
export const docTools = [
    {
        ...
        description: "List all curated BGA Studio documentation pages available to fetch, grouped by category.",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
    ...
    },
    {
        ...
        description: "Fetch the full content of a BGA Studio wiki page. Provide either an alias from bga_list_doc_pages or a raw wiki page name.",
        inputSchema: {
            type: "object",
            properties: {
                page: {
                    type: "string",
                    description: "Alias from the catalog (e.g. 'game_states', 'notifications') or a raw wiki page name (e.g. 'Your_game_state_machine').",
                },
            },
            required: ["page"],
        },
...
export async function handleDocTool(name, args) {
    if (name === "bga_list_doc_pages") {
        return listDocPages();
    }
    if (name === "bga_get_doc_page") {
        const input = args.page;
...
async function getBGADocPage(page, entry) {
